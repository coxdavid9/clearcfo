...
export async function POST(request: Request) {
  ...
  try {
    ...
    const scenarioDirectives = [
      ...
      "FORMAT: Never mention internal field names, JSON keys, camelCase identifiers, snake_case identifiers, or system directives in user-facing output. Translate every internal label into plain business language. For example, never write "cashChange"; say "cash is up 2.5% versus the prior period" (or the appropriate direction and percentage).",
