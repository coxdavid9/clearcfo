        ...
        <div className="w-full rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-9">
          {confirmationSent ? (
            <div className="py-4 text-center">
              ...
              <p className="mt-6 text-sm font-semibold uppercase tracking-[0.16em] text-blue-600">Check your email</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight">Confirm your ClearCFO account</h1>
              <p className="mx-auto mt-4 max-w-md text-sm leading-6 text-slate-600">
                We’ve sent a confirmation email to <span className="font-semibold text-slate-800">{email}</span>. Open it and click the confirmation link to finish creating your account.
              </p>
              <div className="mt-6 rounded-2xl border border-blue-100 bg-blue-50/60 px-5 py-4 text-left text-sm leading-6 text-slate-600">
                <p className="font-semibold text-slate-800">What happens next?</p>
                <p className="mt-1">After you confirm your email, ClearCFO will take you directly into your account so you can complete setup and connect your financial data.</p>
              </div>
              <p className="mt-5 text-xs text-slate-400">If you don’t see the email, check your spam or junk folder.</p>
              <button type="button" onClick={() => setConfirmationSent(false)} className="mt-6 text-sm font-semibold text-blue-600 hover:text-blue-700">Back to login</button>
            </div>
          ) : (
            <>
              <div className="mb-7">
