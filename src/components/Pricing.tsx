...
const plans = [
  ...
  },
  {
    ...
    features: ["Deeper financial analysis", "Everything in Core", "Expanded historical insights", "Priority decision support", "Weekly CFO report"],
    popular: true,
  },
];
