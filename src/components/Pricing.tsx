...
const plans = [
  {
    ...
    features: [
      "CFO Briefing — what happened, why, and what to look at",
      "Revenue & margin analysis — where money was made or lost",
      "Expense analysis — where spending moved and why",
      "Cash & working capital — where your cash stands right now",
      "Customer & vendor movers — who drove the change",
      "AI recommendations — what to investigate next, with dollar impact",
    ],
  },
  {
    name: "Pro",
    ...
    features: [
      "Everything in Core",
      "Weekly CFO report — the key numbers in your inbox every Monday",
      "Automatic syncing — always current, no manual refresh",
      "Proactive alerts — warned before small issues grow",
      "Custom alerts — set your own thresholds, like cash below $10K",
      "Up to 5 businesses — all your companies in one login",
      "Budget vs. actuals — track spending against your plan",
    ],
    popular: true,
  },
];
