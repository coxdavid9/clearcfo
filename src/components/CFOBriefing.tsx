    ...
    <div className="px-5 py-8 sm:px-8 sm:py-12 lg:py-16">
      <div className="mx-auto w-full max-w-6xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_25px_80px_-35px_rgba(15,23,42,0.35)]">
        ...
        <div className="p-7 sm:p-10">
          ...
          {data.emergingConstraints?.length ? (
            <section className="mt-8" aria-labelledby="emerging-constraints-heading">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-amber-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-amber-700">{data.emergingConstraints.length} detected</span>
              </div>
              <div className="mt-4 space-y-4">
                {data.emergingConstraints.map((constraint) => {
                      ...
                      <div className="mt-5 space-y-4">
                        ...
                        <div>
                          ...
                          <ul className="mt-1.5 space-y-1.5 text-sm leading-6 text-slate-600">
                            {constraint.evidenceChecked.map((item, index) => <li key={`constraint-evidence-${index}`} className="flex gap-2"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-slate-300" />{item}</li>)}
                          </ul>
                        </div>
                        <div>
