    ...
    <section id="why-clearcfo" className="scroll-mt-24 border-y border-slate-200 bg-white px-5 py-20 sm:px-8 lg:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {reasons.map((reason) => (
            <div key={reason.title} className="rounded-2xl border border-slate-200 bg-slate-50/60 p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-white hover:shadow-lg">
