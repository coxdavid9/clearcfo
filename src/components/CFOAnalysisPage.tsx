...
function analysisFingerprint(input: BriefingData) {
  return JSON.stringify({
    ...
    dataAvailability: input.dataAvailability ?? { cash: true, inventory: true },
