...
const scenarios = [
  ["alert 5 minutes before time is due", alertDue(new Date("2026-09-19T11:55:00Z"), base)],
  ["alert 3 minutes before time is due", alertDue(new Date("2026-09-19T11:57:00Z"), base)],
  ["alert earlier than lookahead is not due", !alertDue(new Date("2026-09-19T11:50:00Z"), base)],
  ...
  ["alert remains idempotent inside lookahead window", !alertDue(new Date("2026-09-19T11:58:00Z"), { ...base, last_alert_delivery_at: "2026-09-19T11:55:00Z" })],
  ["weekly only due on configured weekday", !weeklyDue(new Date("2026-09-22T12:00:00Z"), base)],
  ["weekly 3 minutes before time is due", weeklyDue(new Date("2026-09-21T12:27:00Z"), base)],
  ["weekly earlier than lookahead is not due", !weeklyDue(new Date("2026-09-21T12:20:00Z"), base)],
